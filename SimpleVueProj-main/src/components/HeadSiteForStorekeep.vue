<template>
  <div class="header">
    <router-link to="/storekeeper">
      <img src="../views/assect/Home.svg" alt="StockTrack Pro Logo">
    </router-link>
    <router-link to="/">
      <img src="../views/assect/logout.svg" alt="StockTrack Pro Logo" width="45" height="35" class="logout">
    </router-link>
  </div>
</template>
...
export default {
  ...
  methods: {
    checkRole(){
      ...
      //
      // console.log(decoded);
      if (localStorage.getItem("role") !== "Кладовщик"){
        router.push('/login');
      }
    }
  }
